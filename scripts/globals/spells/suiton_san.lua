...
function onSpellCast(caster,target,spell)
    ...
    if caster:getMerit(tpz.merit.SUITON_SAN) > 1 then
        bonusAcc = bonusAcc + caster:getMerit(tpz.merit.SUITON_SAN)
        bonusMab = bonusMab + caster:getMerit(tpz.merit.SUITON_SAN)
    end
